...
namespace PlatoUI.UI.Components
{
    public class Component : IComponent
    {
        ...
        public Component(IPlatoUIHelper helper)
        {
            Helper = helper;
        }
        ...
        public virtual IComponent New(IPlatoUIHelper helper)
        {
            return (IComponent) Activator.CreateInstance(this.GetType(),helper);
        }

        public virtual IComponent Clone(IPlatoUIHelper helper, string id = "", IComponent parent = null)
        {
